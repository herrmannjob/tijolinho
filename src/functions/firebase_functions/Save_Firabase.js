...
class Tarefas {
    constructor() {
        this.tarefas = [];
        this.addTarefa = function (cronogramaObraId, nome_tarefa, responsavel = null, status = null, data_inicio = null, data_fim = null){
            let tarefa = new Player(cronogramaObraId, nome_tarefa, responsavel, status, data_inicio, data_fim )
            this.tarefas.push(tarefa);
            return tarefa
        }
        this.removeTarefa = function (value) {
            var indice = this.tarefas.indexOf(value);
            this.tarefas.pud(indice);
        };
